...
[![Gates](https://img.shields.io/badge/gates-135%20passing-brightgreen.svg)](./tests)
...
└── scripts/ (138)      # engine determinista (graph, archive, eval, provenance, hooks, …) — inclui lib/ e tests/
